<?php
/*
Plugin Name: Author Box Reloaded Skype Contact Addon
 ...
 * Section to modify
 */
function skype_authorbox_add_sites( $known_sites ) {					// CHANGE the function prefix name
	$known_sites['Skype'] = array(							// CHANGE the key name
		'favicon' => plugin_dir_url( __FILE__ ) . 'images/skype.png',		// CHANGE the image name
		'url' => 'skype:USERNAME',						// CHANGE the service URI 
		'plugin' => array (
...
add_filter('authorbox_known_sites','skype_authorbox_add_sites',10,1);			// CHANGE the function prefix name
