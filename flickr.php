<?php
/*
Plugin Name: Author Box Reloaded Flickr Contact Addon
 ...
 * Section to modify
 */
function flickr_authorbox_add_sites( $known_sites ) {					// CHANGE the function prefix name
	$known_sites['Flickr'] = array(							// CHANGE the key name
		'favicon' => plugin_dir_url( __FILE__ ) . 'images/flickr.png',		// CHANGE the image name
		'url' => 'http://www.flickr.com/photos/USERNAME',			// CHANGE the service URI 
		'plugin' => array (
...
add_filter('authorbox_known_sites','flickr_authorbox_add_sites',10,1);			// CHANGE the function prefix name
